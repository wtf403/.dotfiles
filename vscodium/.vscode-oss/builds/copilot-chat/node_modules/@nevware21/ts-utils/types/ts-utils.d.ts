 ...
 */
export declare type EnumNameMap<E = any, I = keyof E> = {
 ...
 */
export declare type EnumTypeMap<E, V> = {
 ...
 */
export declare type EnumValueMap<E = any, V = E[keyof E]> = {
